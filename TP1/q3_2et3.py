...
# C:\Users\user\Desktop\TAL\RepoGit\ET5_TAL\TP1\data\formal-tst.NE.key.04oct95_sample.txt
path_out = path_in + '.ne.nltk'
x = re.search("\.txt$", path_in)
if not x:
    raise ValueError("Le parametre d'entree n'est pas un .txt")

print('Nom du fichier texte en entree :', path_in) # formal-tst.NE.key.04oct95_sample.txt
print('Nom du fichier de sortie :', path_out) # formal-tst.NE.key.04oct95_sample.ne.nltk
