...
print('Nom du fichier d entree :',  path_in)  # formal-tst.NE.key.04oct95_small.txt.ne.stanford
...
# Vérification du nombre d'entités nommées dans le texte
somme = 0
for couple in entity_dictionary.values():
	somme += couple[1]

assert(somme == global_counter)
